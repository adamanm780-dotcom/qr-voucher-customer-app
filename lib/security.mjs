...
// Zusätzlich die native FlowState-Wallet-App (Capacitor) + lokale App-Vorschau.
const ALLOWED_ORIGINS = new Set([
  'https://qr-voucher-customer-app.vercel.app',
  'https://flowstate-wallet.de',      // eigene Domain (IONOS → Vercel)
  'https://www.flowstate-wallet.de',
  'http://localhost:3000',
  'capacitor://localhost',   // iOS-App (Capacitor WKWebView)
  'ionic://localhost',       // ältere Capacitor/iOS
  'http://localhost',        // Android-App / lokale Tools
  'https://localhost',
  'http://localhost:5180',   // App-Web-Vorschau (serve.mjs)
]);
